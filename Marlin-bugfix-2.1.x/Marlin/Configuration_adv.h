...
#define SENSORLESS_BACKOFF_MM  { 2, 2, 2, 2, 2, 2 }  // (linear=mm, rotational=°) Backoff from endstops before sensorless homing

#define HOMING_BUMP_MM      { 0, 0, 2, 0, 0, 0 } // (linear=mm, rotational=°) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 2, 2, 4, 4, 4, 2 } // Re-Bump Speed Divisor (Divides the Homing Feedrate)

#define HOMING_BACKOFF_POST_MM { 1, 1, 0, 0, 0, 0 }  // (linear=mm, rotational=°) Backoff from endstops after homing
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT_HOME  X_CURRENT        // (mA) RMS current for sensorless homing  ( X_CURRENT if not sensorless)
    ...
    #define Y_CURRENT_HOME  Y_CURRENT         // Y_CURRENT if not sensorless
  ...
  #define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define IMPROVE_HOMING_RELIABILITY // Enabled for sensorless homing
  #endif
