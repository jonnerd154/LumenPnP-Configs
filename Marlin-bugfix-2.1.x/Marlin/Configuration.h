...
#define X_MIN_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.  // False for SENSORLESS HOMING
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 40, 4.44, 4.44, 40 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 5000, 5000, 2000, 3000, 3000, 3000 }
...
#define Z_AFTER_HOMING  28.4      // (mm) Height to move to after homing Z
...
// Enable RS-485 for Opulo Feeder Communication
